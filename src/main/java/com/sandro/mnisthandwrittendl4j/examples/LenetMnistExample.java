 ...
 ***************************************************************************** */
package com.sandro.mnisthandwrittendl4j.examples;
...
public class LenetMnistExample {
    ...
    public static void main(String... args) throws Exception {
        ...
        model.setListeners(new ScoreIterationListener(1000), new EvaluativeListener(mnistTest, 1, InvocationType.EPOCH_END)); //Print score every 10 iterations and evaluate on test set every epoch
        model.fit(mnistTrain, nEpochs);

        String path = "./lenetmnist.zip";
        ...
        INDArray result = model.output(Nd4j.create(arr));
        System.out.println(Arrays.toString(result.toFloatVector()));
//        // load test images
//        System.out.println("Loading test images.");
//        List<ImageModel> testImages = new MnistImagesLoader().loadImages(TEST_IMAGES_FILE_PATH, TEST_LABELS_FILE_PATH, TEST_SET_SIZE);
//
//        // test model
...
//        new NeuralNetworkManager().test(model, input, expectedOutput);
    }
}
